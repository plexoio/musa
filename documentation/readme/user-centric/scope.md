...
|                       | Present Official Cards in Row        | As a user, I want to see a 'Official' section beneath the 'Campaign' row, presenting single-related events, so that I can preview events related to this category. |
|                       |                                      | As a user, I want each card to display key information related to the event, so I understand what I'm clicking on. |
...
|                       | Create User & Admin Dashboard        | As a user or admin, I want to login or signup so that I can find a useful dashboard with key stats & menu options, based on my role, to interact with the system securely and smoothly. |
...
|                       | Implement Badge Activation           | As a user, I want to use KYC along with other verification methods to get a badge which will be visible on my dashboard and on my created events, to enhance trust in the campaign. |
...
|                       |                                      | As a user with publisher role, I want to create events once verified, but still need approval from the admin side, for my voting event to be published. |
